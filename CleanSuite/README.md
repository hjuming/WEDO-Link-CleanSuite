...
> **注意**：本專案目前處於 **v1.3.0** 版本。核心清理邏輯和系統掃描引擎已實作，並新增了 App Dock 圖示支援。
...
| **智慧系統掃描 (Smart Scan)** | 全新系統掃描引擎，可分析快取、日誌、垃圾桶與 Xcode DerivedData。 |
| **清理報告 (Clean Report)** | 清理完成後顯示詳細的釋放空間報告。 |
...
- [x] **v1.3**: 核心清理引擎實作 (Smart Scan & Clean Report)
- [ ] **v1.4**: 系統掃描邏輯與深度清理
- [ ] **v1.5**: 排程器與自動化功能
- [ ] **v2.0**: 雲端同步與偏好設定
- [ ] **未來**: 公證與簽署發布
